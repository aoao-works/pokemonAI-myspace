...
JSON_DIRECTORY  = _os.path.join(HERE, '..', 'archive')
...
EPOCHS          = 15
LEARNING_RATE   = 1e-3
MODEL_PATH      = _os.path.join(HERE, '..', 'submission', 'ptcg_baseline_model.pth')
NORM_PATH       = _os.path.join(HERE, '..', 'submission', 'ptcg_normalization.npz')
