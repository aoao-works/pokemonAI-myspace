...
# 独立たねポケモン・ザルードを採用（[[project-next-steps]] 2026-07-09: たね4枚のみだと
# 初手マリガン率60.1%、8枚まで増やすと34.6%に低減）。
...
_SEARCH_PRIORITY: dict[int, int] = {
    CID_ISHIZUMAI: 0, CID_IWAPARESU: 1, CID_ZARUDE: 2,
}
...
# 主砲強化系（ヒーローマント等）とは逆にイシズマイへ優先して貼る。ザルードはHPが厚く
# 緊急度が下がるので中間。
